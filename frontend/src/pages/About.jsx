  ...
  return (
    <section className="grid min-h-screen place-items-center">
      <div className="p-4 flex flex-col items-center gap-8 justify-center">
        ...
        <p className="font-inter  text-base md:text-lg lg:text-xl leading-relaxed md:leading-loose text-gray-700">
          This project enables users to manage their accounts, view balances,
          and easily transfer funds to contacts.
          <br></br> Our mission was to create a streamlined, user-friendly
          payment experience with a modern tech stack and robust{" "}
        </p>
        ...
        {backend.map((tech) => {
          return (
            <ul key={tech.title}>
              <li className="font-inter text-lg  text-gray-800">
